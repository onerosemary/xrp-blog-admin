<template>
  <div class="container">
    <div class="handle-box">
      ...
      <el-input v-model="query.name" placeholder="门店名" class="handle-input mr10" size="small"></el-input>
      <el-button type="primary" icon="el-icon-search" @click="handleSearch" size="small">搜索</el-button>
      <el-button type="primary"  @click="handleEdit" size="small">添加门店</el-button>
    </div>
    <el-table
      v-loading="loading"
      class="base-table"
